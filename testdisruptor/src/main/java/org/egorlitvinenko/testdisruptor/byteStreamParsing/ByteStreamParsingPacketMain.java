...
import org.egorlitvinenko.testdisruptor.byteStreamParsing.reader.ByteStreamPacketReaderFromQuotedCsv;
 ...
 */
public class ByteStreamParsingPacketMain {
    ...
    public static void runTest() throws Exception {
        ...
        ByteStreamPacketReaderFromQuotedCsv reader = new ByteStreamPacketReaderFromQuotedCsv(
                (byte) '\n', (byte) ',', (byte) '"',
                testData.columnTypes,
