 ...
 */
public class StringToInt32ParseBatchHandler extends AbstractParseBatchHandler<
        Int32ParserResult,
        Int32ParsingStrategy> {

    public StringToInt32ParseBatchHandler(Int32ParsingStrategy parsingStrategy,
                                          int[] myColumns) {
